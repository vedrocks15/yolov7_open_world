...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, 
        ...
        try:
            ...
            for p in path if isinstance(path, list) else [path]:
                ...
                # Checking if the input file or directory....
                if p.is_dir():  # dir
        ...
        self.batch = bi  # batch index of image [0,0,0,... 1,1,1,1...]
        self.n = n
    ...
    def cache_labels(self, path=Path('./labels.cache'), prefix=''):
        ...
        # both are of equal count, this is ensured before hand...
        pbar = tqdm(zip(self.img_files, self.label_files), desc='Scanning images', total=len(self.img_files))
        
        # looping over each image & label file.....
    ...
    def __getitem__(self, index):
        ...
        # for open world we plan to keep the augmentations off...
        hyp = self.hyp
        ...
        # loaded image, open_world_vectors, image file path name, various shapes....
    ...
    def collate_fn(batch):
        ...
        for i, l in enumerate(label):
            # filling image indices in the extra column created....
